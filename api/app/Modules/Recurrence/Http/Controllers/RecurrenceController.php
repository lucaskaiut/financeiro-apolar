...
class RecurrenceController extends ApiController
{
    ...
    public function show(Recurrence $recurrence): JsonResponse
    {
        ...
        return $this->success(RecurrenceResource::make($recurrence->load(['bankAccount:id,uuid,name', 'costCenter:id,uuid,name', 'category:id,uuid,name', 'subcategory:id,uuid,name'])));
    }
